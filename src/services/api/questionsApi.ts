...
export const fetchQuestions = async (title: string, fromDate: number): Promise<IResponse> => {
  ...
  return await axios.get(url, { method: 'GET', headers: { 'Content-Type': 'application/json' } });
};